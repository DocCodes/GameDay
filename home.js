    ...
    [
      {
        ...
        'text': [
          ...
          'The beauty of <i>GameDay</i> is that it requires no setup and runs completely in a browser; no need to compile or interpret any code&ndash; JS (<a href="https://www.ecma-international.org/ecma-262/7.0/">ES7</a>). An individual could develop a generator or preview for <i>GameDay</i>.'
        ]
      },
      {
        'proton': 'textbox',
